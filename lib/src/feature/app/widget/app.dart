...
import 'package:test_bro/src/feature/app/widget/material_context.dart';
...
import 'package:test_bro/src/feature/initialization/widget/dependencies_scope.dart';
  ...
  Widget build(BuildContext context) => DefaultAssetBundle(
        ...
        child: DependenciesScope(
          ...
          child: SettingsScope(
            ...
            quizBloc: result.dependencies.quizBloc,
